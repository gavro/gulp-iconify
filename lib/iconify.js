...
imacss.partialtransform = function partialtransform (glob, css, svgoOptions) {
    ...
    execution.run(function () {
        function normalizeSVGs (image, enc, callback) {
            if(image.mime === 'image/svg+xml') {
                if(typeof svgoOptions !== 'undefined' && (typeof svgoOptions.enabled === 'undefined' || svgoOptions.enabled === true)) {
                    if(typeof svgoOptions.options === 'object') {
                        var svg = new svgo(svgoOptions.options);
                    } else {
                        var svg = new svgo();
                    }
...
module.exports = function(opts) {
    ...
    var bufferContents = function(file) {
        if(noConvert) {
            ...
            imacss
                .partialtransform(file, 'icon', opts.svgoOptions)
